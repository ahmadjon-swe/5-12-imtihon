...
const { register, login, logout, verify, delete_account, resend_otp, change_password, forgot_password, forgot_password_verify, getMyProfile} = require("../controller/auth.controller")
...
// for profile
authRouter.get("/get_my_profile", authorization, getMyProfile)
