        ...
        <div className="container">
          ...
          <div className="car-detail">
            ...
            <div className="car-detail-gallery">
              <div className="car-detail-main-image">
                <img
                  ...
                  onError={(e) => {
                    e.target.src =
                      "https://placehold.co/824x444/1a1a24/888?text=No+Image";
                  }}
                />
              </div>
              <div className="car-detail-img-toggle">
                <button
                  className={`btn btn-sm ${imgMode === "outer" ? "btn-primary" : "btn-outline"}`}
                  onClick={() => setImgMode("outer")}
                >
                  🚗 Tashqi
                </button>
                <button
                  className={`btn btn-sm ${imgMode === "inner" ? "btn-primary" : "btn-outline"}`}
                  onClick={() => setImgMode("inner")}
                >
                  🪑 Ichki
                </button>
              </div>
              {/* Main image thumbnail — 289x220 */}
              <div
                style={{
                  marginTop: 10,
                  borderRadius: 10,
              ...
              >
                <img
                  ...
                  onError={(e) => {
                    e.target.src =
                      "https://placehold.co/289x220/1a1a24/888?text=Main";
                  }}
                />
              </div>
            </div>
            ...
            <div className="car-detail-info">
              <div className="car-detail-category">
                {car.category?.name} • {car.color}
              </div>
