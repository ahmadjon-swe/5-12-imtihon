...
const { register, login, logout, verify, delete_account, resend_otp, change_password, forgot_password, logoutByCookie, forgot_password_verify} = require("../controller/auth.controller")
...
authRouter.post("/logout_pro", logoutByCookie)
authRouter.post("/verify", verify)
authRouter.post("/delete_account",authorization, delete_account)
